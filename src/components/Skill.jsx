...
function Skill() {
    ...
    return (
        <div className="flex flex-col justify-center items-center h-[100vh] my-10 md:my-0" id="skill">
            ...
            <div className="flex flex-col flex-wrap border-[2px] border-[#a3a3a3] px-[32px] md:px-24 md:py-5 rounded-3xl">
            <h2 className="text-xl md:text-3xl font-medium text-[#555555] text-center mb-5 md:mb-10 mt-3">Frontend Development</h2>
                ...
                <div className="flex flex-col flex-wrap border-[2px] border-[#a3a3a3] px-[42px] md:px-24 md:py-5 rounded-3xl md:h-[355px] h-auto">
