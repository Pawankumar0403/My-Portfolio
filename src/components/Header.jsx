...
function Header() {
    ...
    return (
        <div>
            <header className="flex justify-around items-center px-5 py-3 mt-3 relative z-30" id="home">
                ...
                <nav>
                    ...
                    <button
                        ...
                        className="fa-solid fa-bars fa-2xl md:hidden relative cursor-pointer z-50 bg-white"
                        onClick={handleClick}
                    ></button>
                    <ul
                        className={`flex-col gap-5 text-[20px] text-right absolute right-14 top-14 py-[5px] px-5 bg-white rounded-lg transition-all duration-300 z-40 ${menuOpen ? 'flex' : 'hidden'}`}
                        id="menu"
                    >
