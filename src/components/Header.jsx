        ...
        <div>
            <header className="flex justify-around items-center px-5 py-3 mt-3" id="home">
                ...
                <nav>
                    ...
                    <ul className={`flex-col gap-5 text-[20px] text-right absolute right-[105px] top-16 py-[5px] px-5 bg-white rounded-l-lg transition-all duration-300 ${menuOpen ? 'flex' : 'hidden'}`} id="menu">
